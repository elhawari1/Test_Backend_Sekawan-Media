        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Manager</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                ...
                                @if ($data->id_role == 3)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/manager/destroy/{{ $data->id_user }}}" class="btn btn-outline-danger">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="/manager/store">
                        @csrf
                        <div class="mb-3">
    ...
    @foreach ($user as $data)
        <div class="modal fade" id="updateModal{{ $data->id_user }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Manager {{ $data->nik }} -
                            {{ $data->username }}</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="/manager/update/{{ $data->id_user }}">
                            @csrf
                            <div class="mb-3">
